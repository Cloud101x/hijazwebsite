  ...
  return (
    <section id="contact" className="relative overflow-hidden py-28 md:py-36">
      ...
      <div className="container-custom relative">
        ...
        >
          <div className="border-gradient relative overflow-hidden rounded-[36px] bg-gradient-to-br from-charcoal via-graphite to-black p-10 shadow-card noise md:p-16">
            <div className="pointer-events-none absolute inset-0">
              <div className="absolute -top-24 left-1/2 h-72 w-[140%] -translate-x-1/2 rounded-full bg-amber/15 blur-3xl" />
            ...
            <div className="relative grid grid-cols-1 gap-12 lg:grid-cols-[1.4fr_1fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-7 text-display-md font-semibold text-gradient-amber">
                  Build the product
                  <br />
                  <span className="font-serif italic text-amber">your industry will copy.</span>
                </h2>

                <p className="mt-6 max-w-xl text-base leading-relaxed text-off-white/55 md:text-lg">
                ...
                <div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-3 text-xs text-off-white/45">
              ...
              <div className="relative">
                <div className="border-gradient relative overflow-hidden rounded-2xl bg-black/50 p-6 backdrop-blur-xl">
                  <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-off-white/45">
                  ...
                  <div className="mt-5 space-y-4">
                    {[
                      ...
                      <div key={field.label}>
                        ...
                        <div className="mt-1.5 rounded-xl border border-white/8 bg-white/[0.03] px-4 py-3 text-sm text-off-white/80">
                          {field.value}
                        </div>
                      </div>
                    ))}
                  ...
                  <button className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-amber to-ember px-5 py-3 text-sm font-medium text-off-white shadow-ember-md transition-all duration-300 hover:shadow-ember-lg">
                    Send brief
                    <svg viewBox="0 0 20 20" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M5 10h10M11 6l4 4-4 4" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                ...
                <div className="pointer-events-none absolute -inset-x-6 -inset-y-6 -z-10 rounded-[36px] bg-amber/15 blur-3xl" />
              </div>
            </div>
          </div>
        </motion.div>
