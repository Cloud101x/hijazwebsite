    ...
    <section id="stack" className="relative overflow-hidden py-28 md:py-36">
      ...
      <div className="container-custom relative">
        <SectionHeading
          ...
          title={
            <>
              ...
              <span className="font-serif italic text-amber">right tool</span> for the work.
            </>
          }
        ...
        <div className="mt-20 grid grid-cols-1 gap-10 lg:grid-cols-[1.05fr_1fr] lg:items-center">
          <div className="border-gradient relative overflow-hidden rounded-3xl bg-charcoal/70 p-8 backdrop-blur-xl shadow-card md:p-10">
            <div className="pointer-events-none absolute inset-0 grid-bg opacity-20" />
            <div className="pointer-events-none absolute -inset-y-20 -left-20 h-64 w-64 rounded-full bg-amber/10 blur-3xl" />
            ...
            <div className="relative flex flex-wrap gap-2.5">
              {tech.map((t, i) => (
                ...
                >
                  ...
                  <span className="text-off-white/85 transition-colors group-hover:text-off-white">
                    {t.name}
                  </span>
                </motion.span>
              ))}
          ...
          <div className="space-y-5">
            {[
              ...
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl border border-white/8 bg-white/[0.02] p-6 transition-all duration-500 hover:border-amber/30 hover:bg-white/[0.04]"
              >
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h4 className="text-base font-medium text-off-white">{item.title}</h4>
                    <p className="mt-2 text-sm leading-relaxed text-off-white/55">{item.desc}</p>
                  </div>
                  <span className="shrink-0 rounded-full border border-amber/20 bg-amber/5 px-2.5 py-1 text-[10px] font-mono uppercase tracking-[0.16em] text-amber">
                    {item.stat}
                  </span>
                </div>
              </motion.div>
